...
public class LocalItemViewHolder extends BaseRecyclerViewHolder<MusicInfo> {
    private TextView mTitle;
    private TextView mMusicInfo;
    private MusicListItemLayout mItemLayout;

    public LocalItemViewHolder(View itemView,
                               final LocalItemRecyclerViewAdapter.OnItemClickListener itemClickListener,
                               final LocalItemRecyclerViewAdapter.OnItemMenuClickListener menuClickListener) {
        super(itemView);
