...
public class SongListNormalViewHolder extends BaseRecyclerViewHolder<MusicInfo> {
    private TextView mTitle;
    private TextView mMusicInfo;
    private MusicListItemLayout mItemLayout;

    public SongListNormalViewHolder(View itemView,
                               final MusicListRecyclerViewAdapter.OnItemClickListener itemClickListener,
                               final MusicListRecyclerViewAdapter.OnItemMenuClickListener menuClickListener) {
        super(itemView);
