...
public class MyGedanListNormalViewHolder extends BaseRecyclerViewHolder<MusicInfo> {
    private TextView mTitle;
    private TextView mMusicInfo;
    private MusicListItemLayout mItemLayout;

    public MyGedanListNormalViewHolder(View itemView,
                                       final MyLocalGedanListRecyclerViewAdapter.OnItemClickListener itemClickListener,
                                       final MyLocalGedanListRecyclerViewAdapter.OnItemMenuClickListener menuClickListener) {
        super(itemView);
        ...
        itemView.findViewById(R.id.iv_more_info).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(menuClickListener!=null){
                    menuClickListener.onItemMenuClick(v,getLayoutPosition()-1);
                }
            }
        });
        //该项的点击事件
        itemView.findViewById(R.id.item_local).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(itemClickListener!=null){
                    itemClickListener.onItemClick(v,getLayoutPosition()-1);
                }
            }
        });
    }
