package com.hudson.donglingmusic.net;
...
public class BMA {
    ...
    public static final int RESPONSE_CODE = 22000;
...
//		}
    ...
    public static class Tag {
         ...
         * @return
         */
        public static String tagSongs(String tagname,int offset, int limit) {
            StringBuffer sb = new StringBuffer(BASE);
    ...
    public static class Billboard {
        ...
        public static int[] billBoards = new int[]{BILLBOARD_NEW_MUSIC,BILLBOARD_ORIGINAL,
                BILLBOARD_HOT_MUSIC, BILLBOARD_EU_UK,BILLBOARD_KING,BILLBOARD_NET_MUSIC,
                BILLBOARD_CLASSIC_OLD};

        public static String getBillBoardTitle(int type){
            switch (type){
                case 1:
                    return "最新歌曲";
                case 200:
