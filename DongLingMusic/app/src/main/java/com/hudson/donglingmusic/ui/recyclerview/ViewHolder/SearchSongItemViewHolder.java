...
public class SearchSongItemViewHolder extends BaseRecyclerViewHolder<MusicInfo> {
    private TextView mTitle;
    private TextView mMusicInfo;
    private MusicListItemLayout mItemLayout;

    public SearchSongItemViewHolder(View itemView,
                                    final SearchResultRecyclerViewAdapter.OnItemClickListener itemClickListener,
                                    final SearchResultRecyclerViewAdapter.OnItemMenuClickListener menuClickListener) {
        super(itemView);
    ...
    public void refreshView(MusicInfo data) {
        ...
        mMusicInfo.setText(data.getArtist());
    }
