...
public class GedanListNormalViewHolder extends BaseRecyclerViewHolder<MusicInfo> {
    private TextView mTitle;
    private TextView mMusicInfo;
    private MusicListItemLayout mItemLayout;

    public GedanListNormalViewHolder(View itemView,
                                     final GedanListRecyclerViewAdapter.OnItemClickListener itemClickListener,
                                     final GedanListRecyclerViewAdapter.OnItemMenuClickListener menuClickListener) {
        super(itemView);
