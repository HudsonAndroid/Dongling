...
public class AlbumListNormalViewHolder extends BaseRecyclerViewHolder<MusicInfo> {
    private TextView mTitle;
    private TextView mMusicInfo;
    private MusicListItemLayout mItemLayout;

    public AlbumListNormalViewHolder(View itemView,
                                     final AlbumListRecyclerViewAdapter.OnItemClickListener itemClickListener,
                                     final AlbumListRecyclerViewAdapter.OnItemMenuClickListener menuClickListener) {
        super(itemView);
