...
public class WordGradientTextView extends TextView {
    
    private final static String TAG = WordGradientTextView.class.getSimpleName();
    ...
    public WordGradientTextView(Context context) {
        super(context, null);
    }

    public WordGradientTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
