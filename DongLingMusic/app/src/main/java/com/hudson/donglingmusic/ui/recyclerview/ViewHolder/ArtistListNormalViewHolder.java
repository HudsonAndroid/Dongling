...
public class ArtistListNormalViewHolder extends BaseRecyclerViewHolder<MusicInfo> {
    private TextView mTitle;
    private TextView mMusicInfo;
    private MusicListItemLayout mItemLayout;

    public ArtistListNormalViewHolder(View itemView,
                                      final ArtistListRecyclerViewAdapter.OnItemClickListener itemClickListener,
                                      final ArtistListRecyclerViewAdapter.OnItemMenuClickListener menuClickListener) {
        super(itemView);
