...
public class DownloadCompleteItemViewHolder extends BaseRecyclerViewHolder<MusicInfo> {
    private TextView mTitle;
    private TextView mMusicInfo;
    private MusicListItemLayout mItemLayout;

    public DownloadCompleteItemViewHolder(View itemView,
                                          final DownloadCompleteItemRecyclerViewAdapter.OnItemClickListener itemClickListener,
                                          final DownloadCompleteItemRecyclerViewAdapter.OnItemMenuClickListener menuClickListener) {
        super(itemView);
