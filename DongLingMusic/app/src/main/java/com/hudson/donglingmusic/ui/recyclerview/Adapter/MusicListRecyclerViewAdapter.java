...
import com.hudson.donglingmusic.ui.recyclerview.ViewHolder.SongListHeaderViewHolder;
import com.hudson.donglingmusic.ui.recyclerview.ViewHolder.SongListNormalViewHolder;
...
public class MusicListRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private SongListHeaderBean mHeaderBean;//头布局的实例
    ...
    public MusicListRecyclerViewAdapter(Context context, SongListHeaderBean songListHeaderBean, ArrayList<MusicInfo> datas){
        mDatas = datas;
        mHeaderBean = songListHeaderBean;
        mLayoutInflater = LayoutInflater.from(context);
    }

    public void setData(SongListHeaderBean songListHeaderBean, ArrayList<MusicInfo> datas){
        mHeaderBean = songListHeaderBean;
        mDatas = datas;
        notifyDataSetChanged();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType){
            case TYPE_NORMAL:
                return new SongListNormalViewHolder(mLayoutInflater.inflate(
                        R.layout.item_recyclerview_local,parent,false),mOnItemClickListener,
                        mOnItemMenuClickListener);
            case TYPE_HEADER:
                return new SongListHeaderViewHolder(mLayoutInflater.inflate(R.layout.item_music_list_header,parent,false));
            case TYPE_BOTTOM:
